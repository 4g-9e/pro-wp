...
2. Type in Business Model in the search form and press the 'Enter' key on your keyboard.
3. Click on the 'Activate' button to use your new theme right away.

== Copyright ==

Business Model WordPress Theme, Copyright (c) 2021, ThemeArile
Business Model is distributed under the terms of the GNU GPLs
...
* Image for Screenshot Image, Credit DMValid / 4 Images
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://pxhere.com/en/license
  Source: https://pxhere.com/en/photo/1684086
  
* Image for Page Header Background Image, Credit Johannes Plenio
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://stocksnap.io/license
  Source: https://stocksnap.io/photo/mountain-landscape-9EMKZ5SQ2K
  
* Image for Testimonial Image, Credit CC0 Public Domain
  License: CC0 1.0 Universal (CC0 1.0)
  License URL: https://pxhere.com/en/license
  Source: https://pxhere.com/en/photo/47650
